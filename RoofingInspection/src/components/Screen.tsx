 ...
 */
const ScreenWithScrolling = forwardRef<KeyboardAwareScrollViewRef, ScreenProps>((props, ref) => {
  const {
    children,
 ...
 */
export const Screen = forwardRef<any, ScreenProps>((props, ref) => {
  const {
    theme: { colors },
    themeContext,
  } = useAppTheme()
    ...
    >
      ...
      >
        {isNonScrolling(props.preset) ? (
          ...
          <ScreenWithScrolling {...props} ref={ref} />
        )}
      </KeyboardAvoidingView>
    </View>
  )
